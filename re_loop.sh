...
GAME="Pitfall: The Mayan Adventure (Win32, 1995)"
BINARY="game/PITFALL.EXE"
TOOLS_PREFIX="python3 tools/"
LABELS="labels.csv"
DEAD_ENDS="dead_ends.md"
MAX_TURNS=150
GIT_ADD="REVERSE.md labels.csv dead_ends.md CLAUDE.md web/ docs/ tools/"
ALLOWED_TOOLS="\
...
Bash(python3 tools/pe_info.py*),\
Bash(python3 tools/strings_dump.py*),\
Bash(python3 tools/find_callers.py*),\
Bash(python3 tools/hexdump.py*),\
Bash(python3 tools/ph_info.py*),\
Bash(python3 tools/ph_dump.py*),\
Bash(python3 tools/instruction_set.py*),\
...
RE tools (${TOOLS_PREFIX}):
  ...
  ${TOOLS_PREFIX}find_callers.py <addr> | --entries | --owner <addr> | --callees <addr>
  ${TOOLS_PREFIX}strings_dump.py [-n N] [-g REGEX] [-r START END] [--rva]
  ${TOOLS_PREFIX}ph_dump.py <LEVELnn.PH> [--block0|--palette|--png]
  ${TOOLS_PREFIX}check_ph.py
  ${TOOLS_PREFIX}render_level.py <LEVELnn.PH> [--tiles|--flags|--all]

Addresses are virtual (image base 0x400000); see CLAUDE.md for conventions.
